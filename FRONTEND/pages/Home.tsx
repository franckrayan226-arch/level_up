    ...
    <div className="pt-20 pb-24">
      ...
      <section className="py-16 md:py-20 bg-surface">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-12 md:gap-y-20 gap-x-4 md:gap-x-6 px-4 md:px-6">
          {products[0] && (
            <Link to={`/product/${products[0].id}`} className="col-span-2 md:col-span-8 group block">
              <div className="aspect-[4/5] md:aspect-[16/9] bg-white mb-4 md:mb-6 relative overflow-hidden">
                <img src={products[0].image} alt={products[0].name} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
              ...
              <div className="flex flex-col xl:flex-row justify-between items-start pt-2 md:w-3/4 gap-1 xl:gap-4">
                <div>
                  <p className="font-headline font-black text-lg md:text-3xl tracking-tighter uppercase">{products[0].name}</p>
                  <p className="font-body text-[10px] md:text-sm text-zinc-500 uppercase tracking-widest mt-1 md:mt-2">{products[0].description?.substring(0, 60)}...</p>
                </div>
                <p className="font-headline font-black text-lg md:text-2xl tracking-tighter whitespace-nowrap shrink-0 mt-1 xl:mt-0">{products[0].price.toLocaleString('fr-FR')} FCFA</p>
              </div>
            </Link>
          )}

          {products[1] && (
            <Link to={`/product/${products[1].id}`} className="col-span-1 md:col-span-4 group block mt-6 md:mt-32">
              <div className="aspect-[3/4] bg-white mb-3 md:mb-6 relative overflow-hidden">
                <img src={products[1].image} alt={products[1].name} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
              ...
              <div className="flex flex-col xl:flex-row justify-between items-start pt-2 gap-1 xl:gap-4">
                <div>
                  <p className="font-headline font-black text-xs md:text-xl tracking-tighter uppercase leading-tight">{products[1].name}</p>
                  <p className="font-body text-[9px] md:text-xs text-zinc-500 uppercase tracking-widest mt-1">Essential</p>
                </div>
                <p className="font-headline font-black text-xs md:text-xl tracking-tighter whitespace-nowrap shrink-0">{products[1].price.toLocaleString('fr-FR')} FCFA</p>
              </div>
            </Link>
          )}

          {products[2] && (
            <Link to={`/product/${products[2].id}`} className="col-span-1 md:col-span-5 group block">
              <div className="aspect-[3/4] bg-white mb-3 md:mb-6 relative overflow-hidden">
                <img src={products[2].image} alt={products[2].name} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
              ...
              <div className="flex flex-col xl:flex-row justify-between items-start pt-2 gap-1 xl:gap-4">
                <div>
                  <p className="font-headline font-black text-xs md:text-xl tracking-tighter uppercase leading-tight">{products[2].name}</p>
                  <p className="font-body text-[9px] md:text-xs text-zinc-500 uppercase tracking-widest mt-1">Technical</p>
                </div>
                <p className="font-headline font-black text-xs md:text-xl tracking-tighter whitespace-nowrap shrink-0">{products[2].price.toLocaleString('fr-FR')} FCFA</p>
              </div>
            </Link>
          )}

          {products[3] && (
            <Link to={`/product/${products[3].id}`} className="col-span-2 md:col-span-7 group block mt-2 md:mt-[-100px]">
              <div className="aspect-square md:aspect-[4/5] bg-white mb-4 md:mb-6 relative overflow-hidden">
                <img src={products[3].image} alt={products[3].name} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
              ...
              <div className="flex flex-col xl:flex-row justify-between items-start pt-2 md:w-3/4 md:ml-auto gap-1 xl:gap-4">
                <div>
                  <p className="font-headline font-black text-lg md:text-3xl tracking-tighter uppercase">{products[3].name}</p>
                  <p className="font-body text-[10px] md:text-sm text-zinc-500 uppercase tracking-widest mt-1 md:mt-2">{products[3].description?.substring(0, 60)}...</p>
                </div>
                <p className="font-headline font-black text-lg md:text-2xl tracking-tighter whitespace-nowrap shrink-0 mt-1 xl:mt-0">{products[3].price.toLocaleString('fr-FR')} FCFA</p>
              </div>
            </Link>
          )}
        </div>
